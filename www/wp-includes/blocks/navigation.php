...
function render_block_core_navigation( $attributes, $content, $block ) {
	...
	$toggle_button_icon        = '<svg width="30" height="22" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 30 22" aria-hidden="true" focusable="false"><rect x="0" y="0" width="30" height="4"></rect><rect x="0" y="9" width="20" height="4"></rect><rect x="0" y="18" width="10" height="4"></rect></svg>';
			...
			<div class="%5$s" style="%7$s" id="%1$s">
				<div class="wp-block-navigation__responsive-close" tabindex="-1" data-micromodal-close>
					<div class="wp-block-navigation__responsive-dialog" aria-label="%8$s">
							<button aria-label="%4$s" data-micromodal-close class="wp-block-navigation__responsive-container-close"><svg xmlns="http://www.w3.org/2000/svg" width="26" height="25" viewBox="0 0 26 25" fill="none"><rect x="0.980469" y="21.2134" width="30" height="4" transform="rotate(-45 0.980469 21.2134)" fill="#323232"></rect><rect x="22.1934" y="24.0419" width="30" height="4" transform="rotate(-135 22.1934 24.0419)" fill="#323232"></rect></svg></button>
